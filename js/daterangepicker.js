...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.applyBtn').html(this.ApplyString);//this.locale.applyLabel);
        this.container.find('.cancelBtn').html(this.CancelString);
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    //{
                    //    console.debug(calendar[row][col]._d);
                    ...
                    //    console.debug('After');
                    //}
                    if ((minDate && calendar[row][col].isBefore(minDate)) || (maxDate && calendar[row][col].hour(0).minutes(0).seconds(0).milliseconds(0).isAfter(maxDate))) {
                        cname = ' off disabled ';
